...
const serviceItems: ServiceItem[] = [
    {
        ...
        text: 'Pads, rotors, calipers, and flushes — we keep your stopping power in top shape.',
    },
    {
        id: 2,
        ...
        text: 'Quick, thorough oil and filter changes using quality conventional or full synthetic oils.',
    },
    {
        id: 3,
        ...
        text: 'Advanced scan tools pinpoint check-engine issues so you\'re not guessing at the cause.',
    },
    {
        id: 4,
        iconClass: 'icon-product-return',
        title: 'Transmission\nService',
        to: '/services/transmission-service',
        text: 'Fluid changes, filter replacements, and full rebuilds to keep your drivetrain running smoothly.',
    },
    {
        id: 5,
        iconClass: 'icon-like',
        title: 'Tire Sales\n& Rotation',
        to: '/services',
        text: 'Balancing, rotation, and new-tire installation on all makes — get the grip you need.',
    },
    {
        id: 6,
